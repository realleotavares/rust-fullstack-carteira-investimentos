...
- **Backend / Web Server:** Hospedado no Render.com utilizando um `Dockerfile` otimizado (Multi-stage build).
- **Banco de Dados:** Hospedado no Neon.tech (PostgreSQL Serverless) com conexão segura via TLS.
